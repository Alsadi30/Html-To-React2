...
import slide1 from '../../assets/images/it_service/slide1.jpg'
import slide2 from '../../assets/images/it_service/slide2.jpg'
import slide3 from '../../assets/images/it_service/slide3.jpg'
...
export default function SliderSection() {
  ...
  <div className="container-fuild">
    <div className="row">
      <div id="rev_slider_4_1_wrapper" className="rev_slider_wrapper fullwidthbanner-container" data-alias="classicslider1" style={{margin:0,backgroundColor:'transparent',padding:0,marginTop:0,marginBottom:0}}>
        ...
        <div id="rev_slider_4_1" className="rev_slider fullwidthabanner" style={{display:"none"}} data-version="5.0.7">
          <ul>
            <li data-index="rs-1812" data-transition="zoomin" data-slotamount="7"  data-easein="Power4.easeInOut" data-easeout="Power4.easeInOut" data-masterspeed="2000"  data-thumb="images/it_service/slide1.jpg"  data-rotate="0"  data-saveperformance="off"  data-title="Computer Services" data-description="">
              {/* <!-- MAIN IMAGE --> */}
              <img src={slide1}  alt="#"  data-bgposition="center center" data-kenburns="on" data-duration="30000" data-ease="Linear.easeNone" data-scalestart="100" data-scaleend="120" data-rotatestart="0" data-rotateend="0" data-offsetstart="0 0" data-offsetend="0 0" data-bgparallax="10" className="rev-slidebg" data-no-retina/>
              {/* <!-- LAYERS --> */}
              {/* <!-- LAYER NR. BG --> */}
              ...
              <div className="tp-caption NotGeneric-Title   tp-resizeme rs-parallaxlevel-0" 
                              ...
                              style={{zIndex: 7, whiteSpace: "nowarp"}}>Computer Services </div>
              {/* <!-- LAYER NR. 3 --> */}
            ...
            <li data-index="rs-181" data-transition="zoomin" data-slotamount="7"  data-easein="Power4.easeInOut" data-easeout="Power4.easeInOut" data-masterspeed="2000"  data-thumb="images/it_service/slide2.jpg"  data-rotate="0"  data-saveperformance="off"  data-title="Easy To Use  Customize" data-description="">
              {/* <!-- MAIN IMAGE --> */}
              <img src={slide2}  alt=""  data-bgposition="center center" data-kenburns="on" data-duration="30000" data-ease="Linear.easeNone" data-scalestart="100" data-scaleend="120" data-rotatestart="0" data-rotateend="0" data-offsetstart="0 0" data-offsetend="0 0" data-bgparallax="10" className="rev-slidebg" data-no-retina/>
              {/* <!-- LAYERS --> */}
              {/* <!-- LAYER NR. BG --> */}
              <div className="tp-caption tp-shape tp-shapewrapper   rs-parallaxlevel-0" 
              ...
              <div className="tp-caption NotGeneric-Title   tp-resizeme rs-parallaxlevel-0" 
                              ...
                              data-responsive_offset="on" 
                              data-elementdelay="0.05" 
                              style={{zIndex: 7, whiteSpace: "nowarp"}}>Fast  Affordable </div>
              {/* <!-- LAYER NR. 3 --> */}
              <div className="tp-caption NotGeneric-SubTitle   tp-resizeme rs-parallaxlevel-0" 
                              ...
                              data-splitout="none" 
                              data-responsive_offset="on" 
                              style={{zIndex: 7, whiteSpace: "nowarp"}}>Available On It.Next </div>
            </li>
            <li data-index="rs-18" data-transition="zoomin" data-slotamount="7"  data-easein="Power4.easeInOut" data-easeout="Power4.easeInOut" data-masterspeed="2000"  data-thumb="images/it_service/slide3.jpg"  data-rotate="0"  data-saveperformance="off"  data-title="Perfectly Responsive" data-description="">
              {/* <!-- MAIN IMAGE --> */}
              <img src={slide3}  alt=""  data-bgposition="center center" data-kenburns="on" data-duration="30000" data-ease="Linear.easeNone" data-scalestart="100" data-scaleend="120" data-rotatestart="0" data-rotateend="0" data-offsetstart="0 0" data-offsetend="0 0" data-bgparallax="10" className="rev-slidebg" data-no-retina/>
              {/* <!-- LAYERS --> */}
              {/* <!-- LAYER NR. BG --> */}
              <div className="tp-caption tp-shape tp-shapewrapper   rs-parallaxlevel-0" 
              ...
              <div className="tp-caption NotGeneric-Title   tp-resizeme rs-parallaxlevel-0" 
                              ...
                              data-responsive_offset="on" 
                              data-elementdelay="0.05" 
                              style={{zIndex: 7, whiteSpace: "nowarp"}}>We Will Fix It </div>
              {/* <!-- LAYER NR. 3 --> */}
              <div className="tp-caption NotGeneric-SubTitle   tp-resizeme rs-parallaxlevel-0" 
                              id="slide-18-layer-4" 
                              data-x="['center','center','center','center']" data-hoffset="['0','0','0','0']" 

...
import ligi1 from '../../assets/images/it_service/team-member-1.jpg'
import ligi2 from '../../assets/images/it_service/team-member-3.jpg'
import ligi3 from '../../assets/images/it_service/team-member-2.jpg'
import ligi4 from '../../assets/images/it_service/team-member-1.jpg'
    ...
    <div className="row">
      <div className="col-md-3 col-sm-6">
        <div className="full team_blog_colum">
          <div className="it_team_img"> <img className="img-responsive" src={ligi1} alt="#"/> </div>
      ...
      <div className="col-md-3 col-sm-6">
        <div className="full team_blog_colum">
          <div className="it_team_img"> <img className="img-responsive" src={ligi3} alt="#"/> </div>
          <div className="team_feature_head">
            <h4>Ruby Jake</h4>
          </div>
          <div className="team_feature_social">
      ...
      <div className="col-md-3 col-sm-6">
        <div className="full team_blog_colum">
          <div className="it_team_img"> <img className="img-responsive" src={ligi2} alt="#"/> </div>
          <div className="team_feature_head">
            <h4>David Hussay</h4>
          </div>
          <div className="team_feature_social">
      ...
      <div className="col-md-3 col-sm-6">
        <div className="full team_blog_colum">
          <div className="it_team_img"> <img className="img-responsive" src={ligi4} alt="#"/> </div>
          <div className="team_feature_head">
            <h4>Dean Michael</h4>
          </div>
          <div className="team_feature_social">

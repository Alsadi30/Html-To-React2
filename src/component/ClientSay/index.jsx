...
import lot1 from '../../assets/images/it_service/client1.jpg'
import lot2 from '../../assets/images/it_service/client2.jpg'
import lot3 from '../../assets/images/it_service/client3.jpg'
                  ...
                  <div className="carousel-inner">
                    <div className="carousel-item active">
                      <div className="testimonial-container">
                        ...
                        <div className="testimonial-photo"> <img src={lot1} className="img-responsive" alt="#" width="150" height="150"/> </div>
                    ...
                    <div className="carousel-item">
                      <div className="testimonial-container">
                        <div className="testimonial-content"> You guys rock! Thank you for making it painless, pleasant and most of all hassle free! I wish I would have thought of it first. 
                          I am really satisfied with my first laptop service. </div>
                        <div className="testimonial-photo"> <img src={lot2} className="img-responsive" alt="#" width="150" height="150"/> </div>
                        <div className="testimonial-meta">
                          <h4>Maria Anderson</h4>
                          <span className="testimonial-position">CFO, Tech NY</span> </div>
                      </div>
                    ...
                    <div className="carousel-item">
                      <div className="testimonial-container">
                        <div className="testimonial-content"> You guys rock! Thank you for making it painless, pleasant and most of all hassle free! I wish I would have thought of it first. 
                          I am really satisfied with my first laptop service. </div>
                                                    <div className="testimonial-photo"> <img src={lot3} className="img-responsive" alt="#" width="150" height="150"/> </div>
                        <div className="testimonial-meta">
                          <h4>Maria Anderson</h4>
                          <span className="testimonial-position">CFO, Tech NY</span> </div>
                      </div>
